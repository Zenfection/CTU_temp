...
| 5                                                                                                                          | <img title="" src="https://raw.githubusercontent.com/Zenfection/Image/master/2021/03/21-16-28-12-A%CC%89nh%20chu%CC%A3p%20Ma%CC%80n%20hi%CC%80nh%202021-03-21%20lu%CC%81c%2016.28.08.png" alt="Ảnh chụp Màn hình 2021-03-21 lúc 16.28.08.png" width="425"> | `TenK`  thuộc `KHACH`<br>`ngayHD` thuộc `HOADON`<br><br><br>Chiếu `TenK` trong `KHACH`1<br>Điều kiện ở `ngayHD` không nằm trong `KHACH`<br>💡`KHACH` và `HOADON` có chung `maK` nên có thể kết nối |
