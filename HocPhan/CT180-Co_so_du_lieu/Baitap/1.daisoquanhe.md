...
| 9                                                                                                                          | <img title="" src="https://raw.githubusercontent.com/Zenfection/Image/master/2021/03/21-17-05-13-A%CC%89nh%20chu%CC%A3p%20Ma%CC%80n%20hi%CC%80nh%202021-03-21%20lu%CC%81c%2017.04.22.png" alt="Ảnh chụp Màn hình 2021-03-21 lúc 17.04.22.png" width="285"> | `MaH` ∈ `HANG`<br>`SLBan` ∈ `CHITIETHD`<br>🧚 Dùng phép `trừ`<br>`HANG` - `CHITIETHD` = số hàng còn lại                                                                                     |
